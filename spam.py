...
class SPAM:
    ...
    def run(self):
        while True:
            self.banner()
            self.phone = input(self.format_input("!",f"INPUT PHONE NUMBER: "))
            if self.phone != '0395524153':
                if len(self.phone) == 10:
                    break
                print(self.format_print("%", "PHONE NUMBER <10!"))
            if self.phone == '0395524153':
                print(self.format_print("%", "NO SPAM PHONE NUMBER ADMIN!"))
            time.sleep(3)
